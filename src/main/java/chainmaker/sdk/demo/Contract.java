...
public class Contract {
     ...
     * @param chainClient
     */
    public static void invokeEvidenceContract(ChainClient chainClient) {
        ResultOuterClass.TxResponse responseInfo = null;

        HashMap<String, byte[]> params = new HashMap<>();
        params.put("file_hash", "hash01".getBytes());

        try {
            responseInfo = chainClient.invokeContract("evidence_contract", "find_by_file_hash",
